...
public class asansor0 implements Runnable{
	...
	static void asansorYazdir(String s, int bulunKat, int hedefKat, String yon, int icindekiKisiSayisi, int kapasite, int aktiflik) {
